...
const completeTodo = (todoId) => {
    ...
    if(todos[todoIndex].isDone == true) {
        todoCopy = {
            ...todos[todoIndex],
            completedAt: null,
            isDone: false
        ...
        <div class="todo-item" data-id="${todoItemObj.id}">
            <div class="todo-header">
                <div class="todo-details">
                    ...
                    <div class="${
                      todoItemObj.isDone ? "text-line-through" : ""
                    }">
                ...
                <div class="delete-todo-btn" onclick="deleteTodoHandler(${
                  todoItemObj.id
                })">
                    ${
                      todoItemObj.isDeleted
                        ? `
                            <svg
                  ...
                  todoItemObj.isDone
                    ? `
                        <div class="date-wrapper">
                            ...
                            <span class="date">${getFormattedDate(
                              todoItemObj.completedAt
                            )}</span>
                        </div>
                    `
                    : `
                        <div>
                            <div
                                class="category ${todoItemObj.category}"
                            >
                                ${
                                  TODO_CATEGORIES_CLASSES_MAP[
                                    todoItemObj.category
                                  ]
                                }
                            </div>
                        </div>
...
const deleteTodoHandler = (todoId) => {
    ...
    if(todos[todoIndex].isDeleted == true) {
        todoCopy = {
            ...todos[todoIndex],
            isDeleted: false
        }
