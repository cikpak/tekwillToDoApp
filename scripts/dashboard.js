        ...
        <div class="todo-item" data-id="${todoItemObj.id}">
            <div class="todo-header">
                <div class="todo-details">
                    ...
                    <div class="${todoItemObj.isDone === true ? 'line-through': ''}">
            ...
            <div class="todo-footer">
                ${
                    ...
                    ` : `
                        <div>
                            <div class="category ${todoItemObj.category}">
                                ${TODO_CATEGORIES_CLASSES_MAP[todoItemObj.category]}
                            </div>
                        </div>
                    `
                }
